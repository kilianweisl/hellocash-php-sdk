...
class ArticleResourceTest extends TestCase
{
  ...
  function it_can_be_instantiated(): void
  {
    ...
    // Act
    $resource = new ArticleResource($client);
  ...
  public function it_can_fetch_all_articles(): void
  {
    ...
    $mockClient = new MockClient([
      MockResponse::make($this->json('Client/Resources/Articles/GetArticlesRequestStub.json'), 200),
    ]);
    ...
    // Assert
    $this->assertSame('Artikel mit Schnelleingabe', $entries[1]['article_name']);
  }
}
